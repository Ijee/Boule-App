...
public class VorlagenVision extends Vision implements EventHandler<Event>
{
    ...
    private ArrayList<VorlagenEintrag> buildVorlagenList()
    {
        ...
        //TODO: Gehe alle Dateien des PDF Verzeichnis durch, speichere gültige Dateienpfade
        //      und füge diese nach Turniername(Alphabetisch) sortiert der Vorlagenliste hinzu.
